...
export function ProjectDetailsForm({ initialData, onUpdate, onNext }: ProjectDetailsFormProps) {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Briefly describe what this project is about.</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
