    ...
    <Tabs defaultValue="overview" className="mt-6">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Next: Team Standup (1h)</p>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">GitHub, Slack, Calendar</p>
            </CardContent>
          </Card>
        </div>
      ...
      <TabsContent value="tasks" className="mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>View and manage all your tasks across different platforms.</CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <TabsContent value="meetings" className="mt-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>View upcoming meetings and their details.</CardDescription>
          </CardHeader>
          <CardContent>
            <p>Meeting management content will appear here.</p>
          </CardContent>
        </Card>
      </TabsContent>
      <TabsContent value="integrations" className="mt-6">
        <Card>
          ...
          <CardContent>
            <p>Integration management content will appear here.</p>
          </CardContent>
        </Card>
      </TabsContent>
    </Tabs>
